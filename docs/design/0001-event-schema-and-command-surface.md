...
| `gwl-jobs ingest --file <path>`                                  | Same, from a local HTML/text drop.                                                                                                                                                                                                                                                                                             | same                                                                        |
| `gwl-jobs list [--all]`                                          | Print the active pipeline: every non-terminal, non-ignored lead, ranked by score (design doc 0002). Each row shows rank, composite score, title @ company, deferral count, lifecycle-status tag, and the lead's UUID prefix (the addressing handle — design doc 0002, decision 0008). `--all` adds terminal and ignored leads. | —                                                                           |
